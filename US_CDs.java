...
public class US_CDs extends BaseTest{
     WebDriver driver;
     @BeforeClass
        ...
        @Test
        public void US_CDsEnd2021VsEnd2022() throws InterruptedException {
        ...
        @Test
        public void US_CDs_YieldToWorstRangeTest() throws InterruptedException {
        	String nameofCurrMethod = new Throwable().getStackTrace()[0].getMethodName();
    		test = report.startTest(nameofCurrMethod);
        ...
        @Test
        public void US_CDs_CouponRangesTest() throws InterruptedException {
        	String nameofCurrMethod = new Throwable().getStackTrace()[0].getMethodName();
    		test = report.startTest(nameofCurrMethod);
            ...
            //Click Edit and change from 10 to 5
            Utils.GetResultsEditButton(driver).click();       
        ...
        @Test
        public void US_CDs_CouponRangesTestSmallerGap() throws InterruptedException {
        	String nameofCurrMethod = new Throwable().getStackTrace()[0].getMethodName();
    		test = report.startTest(nameofCurrMethod);
            ...
            //Click Edit and change from 5 to 2
            Utils.GetResultsEditButton(driver).click();       
             
            Utils.GetCouponMax(driver).clear();
            Utils.GetCouponMax(driver).sendKeys("2");
